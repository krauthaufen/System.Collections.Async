...
namespace System.Collections.Async.Tests
{
    ...
    public class RangeTests
    {
        ...
        {
            var xs = AsyncEnumerable.Range(int.MaxValue, 1, CancellationToken.None).ToArrayAsync(CancellationToken.None).Result;
        ...
        {
            var xs = AsyncEnumerable.Range(10, 3, CancellationToken.None).ToArrayAsync(CancellationToken.None).Result;
