    ...
    public class SumTests
    {
        ...
        public void ThrowsWhenSourceIsNull1()
        {
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<decimal>)null, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<double>)null, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<float>)null, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<int>)null, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<long>)null, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<uint>)null, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<ulong>)null, CancellationToken.None).Wait()
                );
        ...
        {
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<decimal>)null, x => x, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<double>)null, x => x, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<float>)null, x => x, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<int>)null, x => x, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<long>)null, x => x, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<uint>)null, x => x, CancellationToken.None).Wait()
                );
            TestHelpers.ThrowsAggregateArgumentNullException(
                () => AsyncEnumerable.SumAsync((IAsyncEnumerable<ulong>)null, x => x, CancellationToken.None).Wait()
                );
        ...
        {
            _SumFailsWhenCancelled(() => Assert.IsTrue(AsyncEnumerable.Empty<decimal>().SumAsync(x => x, Helper.CANCELLED).Result == 0));
            _SumFailsWhenCancelled(() => Assert.IsTrue(AsyncEnumerable.Empty<double>().SumAsync(x => x, Helper.CANCELLED).Result == 0));
            _SumFailsWhenCancelled(() => Assert.IsTrue(AsyncEnumerable.Empty<float>().SumAsync(x => x, Helper.CANCELLED).Result == 0));
            _SumFailsWhenCancelled(() => Assert.IsTrue(AsyncEnumerable.Empty<int>().SumAsync(x => x, Helper.CANCELLED).Result == 0));
            _SumFailsWhenCancelled(() => Assert.IsTrue(AsyncEnumerable.Empty<long>().SumAsync(x => x, Helper.CANCELLED).Result == 0));
            _SumFailsWhenCancelled(() => Assert.IsTrue(AsyncEnumerable.Empty<uint>().SumAsync(x => x, Helper.CANCELLED).Result == 0));
            _SumFailsWhenCancelled(() => Assert.IsTrue(AsyncEnumerable.Empty<ulong>().SumAsync(x => x, Helper.CANCELLED).Result == 0));
        ...
        public void SumDecimalValues()
        {
            ...
            Assert.IsTrue(xs.SumAsync(CancellationToken.None).Result == 10);
