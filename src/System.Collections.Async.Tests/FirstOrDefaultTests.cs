...
namespace System.Collections.Async.Tests
{
    ...
    public class FirstOrDefaultTests
    {
        ...
        public void ThrowsWhenSourceIsNull()
        {
            try
            {
                AsyncEnumerable.FirstOrDefaultAsync<int>(null, CancellationToken.None).Wait();
                Assert.Fail();
            }
            catch (Exception e)
            {
        ...
        public void ThrowsWhenSourceIsNull2()
        {
            try
            {
                AsyncEnumerable.FirstOrDefaultAsync<int>(null, x => true, CancellationToken.None).Wait();
                Assert.Fail();
            }
            catch (Exception e)
            {
        ...
        public void ThrowsOnPredicateIsNull()
        {
            try
            {
                ...
                AsyncEnumerable.FirstOrDefaultAsync<int>(xs, null, CancellationToken.None).Wait();
                Assert.Fail();
            }
            catch (Exception e)
            {
        ...
        {
            var xs = AsyncEnumerable.Empty<int>();
            Assert.IsTrue(xs.FirstOrDefaultAsync(CancellationToken.None).Result == 0);
        }
        ...
        {
            var xs = AsyncEnumerable.Empty<int>();
            Assert.IsTrue(xs.FirstOrDefaultAsync(x => true, CancellationToken.None).Result == 0);
        }
        ...
        public void SingleElement()
        {
            ...
            Assert.IsTrue(xs.FirstOrDefaultAsync(CancellationToken.None).Result == 42);
        }
        ...
        {
            var xs = AsyncEnumerable.FromValue(42);
            Assert.IsTrue(xs.FirstOrDefaultAsync(x => x == 42, CancellationToken.None).Result == 42);
        }
        ...
        {
            var xs = AsyncEnumerable.FromValue(42);
            Assert.IsTrue(xs.FirstOrDefaultAsync(x => x == 17, CancellationToken.None).Result == 0);
        }
        ...
        public void MultipleElementsWithPredicateMatch()
        {
            ...
            Assert.IsTrue(xs.FirstOrDefaultAsync(x => x == 3, CancellationToken.None).Result == 3);
        }
