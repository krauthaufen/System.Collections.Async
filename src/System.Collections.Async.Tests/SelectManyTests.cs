...
namespace System.Collections.Async.Tests
{
    ...
    public class SelectManyTests
    {
        ...
        {
            var xs = AsyncEnumerable.Empty<int>();
            var rs = xs.SelectMany(x => new[] { x }, CancellationToken.None).ToArrayAsync(CancellationToken.None).Result;
        ...
        public void SingleElement()
        {
            ...
            var rs = xs.SelectMany(x => new[] { x, x * 2 }, CancellationToken.None).ToArrayAsync(CancellationToken.None).Result;
        ...
        public void MultipleElements()
        {
            ...
            var rs = xs.SelectMany(x => Enumerable.Range(x, x), CancellationToken.None).ToArrayAsync(CancellationToken.None).Result;
        ...
        public void TSourceIsDifferentFromTResult()
        {
            ...
            var rs = xs.SelectMany(x => new [] { "x", x.ToString() }, CancellationToken.None).ToArrayAsync(CancellationToken.None).Result;
